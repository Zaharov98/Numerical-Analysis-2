...
def predictor_corrector_method(func, x_0, y_0, segment_end, step, accuracy):
    """
...
def main():
    ...
    for accuracy in range(2, 5):
        x_nodes, y_nodes = predictor_corrector_method(given_function, x_0, y_0, segment_end, step, accuracy)
    ...
    print('Predictor-corrector interpolation results')
